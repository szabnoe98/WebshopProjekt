...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2022. Ápr 14. 20:32
...
-- Adatbázis: `webaruhaz`
--
CREATE DATABASE IF NOT EXISTS `webaruhaz` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `webaruhaz`;
-- --------------------------------------------------------
...
(25314, 'Izsáki Durum Szarvacska 500g', 'Izsáki', 38, 400, 457, '500 g', '2021-10-31', NULL, 1),
...
--
ALTER TABLE `rendelesi_tetelek`
  MODIFY `Rendelesi_tetelek_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
